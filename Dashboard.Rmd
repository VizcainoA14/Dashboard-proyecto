...
p <- ggplot(data = Muestra, aes(x = appeared)) +
  geom_histogram(bins = 63,) +
  geom_density(alpha = 0.5, color = "red", position = " ") +
  labs(title = "Histograma y Línea de Densidad de 'appeared' en Muestra") +
  
  # Personalizar la apariencia del título para centrarlo
  theme(plot.title = element_text(hjust = 0.5))

# Convertir el gráfico a una figura interactiva con ggplotly
fig <- ggplotly(p)
